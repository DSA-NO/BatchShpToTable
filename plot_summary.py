...
def plot_CM(run='', countermeasure=''):
    ...
    if run:
        ...
        run = countermeasure + '_' + run[3:].replace(".pkl.bz2", '')
    else:
...
if __name__ == '__main__':
    ...
    # Full sheltering
    run = f'E:/{base60km}4800_grid_toteffout_bitmp_Adults_Total__full.pkl.bz2'
    # plot_CM(run, 'sheltering_partial')

    # Iodine  1 year old
    run = f'E:/{base60km}hyrod_bitmp_1year_Tota__full.pkl.bz2'
    # plot_CM(run, 'iodine_child')

    # Iodine  Adult
    run = f'E:/{base5km}hyrod_bitmp_Adults_Tota__full.pkl.bz2'
    # plot_CM(run, 'iodine_adult')
