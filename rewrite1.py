...
def parse_filename(filepath):
    ...
    return runname, timestamp, metadata_dict
...
if __name__ == "__main__":    
    ...
    metadata = {}
    for x in pp:
        runname, timestamp, metadata_dict = parse_filename(x)
        metadata.setdefault(runname,{})
        metadata[runname][timestamp] = metadata_dict
